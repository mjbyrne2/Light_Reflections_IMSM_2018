...
$$\text{BRDF}(\mathbf{I},\mathbf{V}) = \left(\frac{\langle\mathbf{H},\mathbf{N}\rangle}{\|\mathbf{H}\|}\right)^\alpha \text{ for } \alpha \geq 0$$
...
\item Case where light and viewing vector are parallel
\item Blinn--Phong reduces to scaled $(\cos\theta)^\alpha$ \\\vspace*{0.25 in}
\end{itemize}
