...
\label{fig: OCS_perpendicular_plane}
...
\label{fig: OCS_parallel_plane_ellipsoid}
...
\label{fig: OCS_perpendicular_plane_ellipsoid}
...
\label{fig: OCS_decay_by_alpha_ellipsoid}
