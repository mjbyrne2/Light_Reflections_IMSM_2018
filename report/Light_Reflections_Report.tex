...
\begin{figure}
 \includegraphics[width=.8\textwidth]{./figs/Surfaces.pdf}
\end{figure}
...
\begin{figure}
\includegraphics[width=.8\textwidth]{./figs/checkerboard.pdf}
\end{figure}
...
\begin{figure}
\includegraphics[width=.8\linewidth]{./figs/cubes.pdf}
...
\begin{figure}[H]  	
\centerline{\includegraphics[height=1.4in,width=1.2in]{./figs/facet.png}}
...
\begin{figure}[h]
\includegraphics[width=.7\textwidth]{./figs/OCS_parallel_plane_ellipsoid}
...
\begin{figure}[h]
\includegraphics[width=.7\textwidth]{./figs/OCS_perpendicular_plane_ellipsoid}
...
\end{figure}
\begin{figure}
\includegraphics[width=.7\textwidth]{./figs/OCS_decay_by_alpha_ellipsoid}
...
by~\eqref{equ:induct}.
\begin{figure}[H]
  \includegraphics[width=4in]{./figs/reflection2.pdf}
